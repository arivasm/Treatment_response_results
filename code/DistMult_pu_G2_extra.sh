...
do  
    ...
    do
        ...
        do
            ...
            do
                python main.py --bs $bs --lr $lr --emb_dim $emb_dim --lmbda $lmbda --prior 5e-2 --gpu 0 --loss_type pu --base_model DistMult --graph 2
                python main.py --bs $bs --lr $lr --emb_dim $emb_dim --lmbda $lmbda --prior 5e-3 --gpu 0 --loss_type pu --base_model DistMult --graph 2
